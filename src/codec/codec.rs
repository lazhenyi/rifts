...
pub trait Codec: Send + Sync {
    /// Returns the [`FrameCodec`] enum variant that identifies this encoding
    /// format on the wire.
    ///
...
pub trait CodecExt: Codec {
    ...
    /// [`serde_json::Value`] and then calls [`Codec::encode_value`].
    ///
    /// # Errors
    ///
    ...
    ///
    /// This is a convenience wrapper that first calls [`Codec::decode_value`]
