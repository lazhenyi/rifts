...
/// transport to [`RiftServerBuilder::websocket_transport`](crate::server::RiftServerBuilder::websocket_transport)
...
impl TransportConnection for WebSocketConnection {
    ...
    /// A close frame produces a [`SessionReject::Expired`](crate::error::SessionReject::Expired)
    /// error.
